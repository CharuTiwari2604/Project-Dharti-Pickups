...
//       axios.get("/user/pickups", { withCredentials: true })
//         .then(res => setPickups(res.data))
//         .catch(err => console.log(err));

//       // Fetch user's total Ecopoints
//       axios.get("/user/ecopoints", { withCredentials: true })
//         .then(res => setEcopoints(res.data.ecopoints))
//         .catch(err => console.log("Error fetching ecopoints:", err));
...
//     // // Level system example (simple)
//     const getLevel = (points) => {
//       if (points >= 100) return "Level 3";
...
//           const isComplete = data.location && data.phone && data.bio;
...
//                     {index === 0 ? (
//                       <Crown className="text-yellow-500 mx-auto" size={20} />
//                     ) : (
//                       `#${index + 1}`
//                     )}
//                   </td>
...
//                   <td className="py-3 px-2">
//                     <span
//                       className={`px-3 py-1 rounded-full text-sm font-medium ${user.ecoPoints >= 1000
